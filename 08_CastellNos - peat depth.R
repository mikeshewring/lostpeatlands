## 04 Castell Nos -  peat peat depth interpolation/ krigging####
...
plot(variogramLine(fve, 400), type='l', ylim=c(0,1))
...
# export raster
writeRaster(rdepth, "CastellNosPeatDepth_20191113.tif", overwrite = T)
